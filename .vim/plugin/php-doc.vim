...
let g:pdv_cfg_Package = "BBC"
let g:pdv_cfg_Version = "${pom.version}"
let g:pdv_cfg_Author = "Yavor Atanasov <yavor.atanasov@bbc.co.uk>"
let g:pdv_cfg_Copyright = "2007 - 2012 BBC (http://www.bbc.co.uk)"
let g:pdv_cfg_License = "BBC Proprietary"
